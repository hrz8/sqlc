...
remote-proto:
	protoc \
		--go_out=. --go_opt="Minternal/remote/gen.proto=github.com/hrz8/sqlc/internal/remote" --go_opt=module=github.com/hrz8/sqlc \
        --go-grpc_out=. --go-grpc_opt="Minternal/remote/gen.proto=github.com/hrz8v/sqlc/internal/remote" --go-grpc_opt=module=github.com/hrz8/sqlc \
